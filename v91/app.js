...
(function () {
  ...
  function buildMiniCard(p) {
    ...
    card.style.setProperty("--tape-x", (pr() * 56 + 12).toFixed(1) + "%");
    card.style.setProperty("--tape-rot", (pr() * 76 - 38).toFixed(1) + "deg");
    card.style.setProperty("--tape-w", (pr() * 24 + 26).toFixed(0) + "px");
    card.style.setProperty("--tape-top", (pr() * 7 - 11).toFixed(0) + "px");
