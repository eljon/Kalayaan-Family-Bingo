...
(function () {
  ...
  function applyWornEdge() {
    ...
    var pad = 20, base = 1, amp = 5; // amp = gentle warp/swell depth in px
    var x0 = pad, y0 = pad, x1 = W - pad, y1 = H - pad;
    // each corner worn to a different radius (moderate, keeps room for text)
    function cr() { return rnd(24, 42); }
