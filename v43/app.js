...
(function () {
  ...
  function openCoverflowList(doneTasks, start) {
    ...
    // Each slide is the REAL bingo item (on a scrap of card paper), exactly
    // as it renders on the board — every element present.
    doneTasks.forEach(function (t) {
      var card = document.createElement("div");
      card.appendChild(buildDoneCell(t, cf.urls, null));
