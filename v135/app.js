          ...
          if (clonedCard) {
            Array.prototype.forEach.call(
              ...
              function (cell) {
                ...
                var tilt = (btn && btn.style.getPropertyValue("--tilt")) || "-2deg";
                ...
                pic.style.cssText = "display:block;max-width:82%;max-height:92%;" +
                  "width:auto;height:auto;background:#fff;box-sizing:border-box;" +
                  "border:6px solid #fff;border-bottom-width:16px;" +
