...
(function () {
  ...
  function finishClose() {
    ...
    document.body.style.overflow = "";
    restoreSources();
    // safety net: never leave the page scrolled with the top out of view
  ...
  function openCoverflowList(doneTasks, start, animate) {
    ...
    // Lock the document (not the overlay) so off-screen cards can't scroll the
    // page — this clips only at the true viewport edge, never the visible cards.
