  ...
  function buildMiniCard(p) {
    ...
    TASKS.forEach(function (t) {
      ...
      if (p.done && p.done[t.id]) {
        ...
        // A unique hand-drawn green sharpie check over the accomplished task.
        var chk = document.createElement("div"); chk.className = "wm-check";
        chk.setAttribute("aria-hidden", "true");
        chk.style.backgroundImage = handDrawnCheck(cellSeed(t.id) + "|" + seed);
        mc.appendChild(chk);
      } else {
          ...
          if (clonedCard) {
            Array.prototype.forEach.call(
              ...
              function (cell) {
                ...
                // Fill the whole photo area of the cell; keep only a thin white
                // Polaroid margin. A small tilt would clip against the cell's
                // overflow at this size, so the share photo sits square.
                pic.style.cssText = "display:block;max-width:100%;max-height:100%;" +
