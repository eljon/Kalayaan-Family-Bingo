...
(function () {
  ...
  // Little burst marks drawn around each activity icon (like the poster).
  var SPARK_SVG =
    '<svg class="cell-spark" viewBox="0 0 80 80" fill="none" stroke="currentColor" ' +
    'stroke-width="3.2" stroke-linecap="round" aria-hidden="true">' +
    '<line x1="8" y1="22" x2="16" y2="26"/>' +
    '<line x1="5" y1="38" x2="14" y2="37"/>' +
    '<line x1="17" y1="10" x2="22" y2="17"/>' +
    '<line x1="72" y1="22" x2="64" y2="26"/>' +
    '<line x1="75" y1="38" x2="66" y2="37"/>' +
    '<line x1="63" y1="10" x2="58" y2="17"/>' +
    '</svg>';
  ...
  function renderBoard() {
    ...
    TASKS.forEach(function (task) {
      ...
      // Icon area: decorative bursts + emoji, or the photo thumbnail once done
