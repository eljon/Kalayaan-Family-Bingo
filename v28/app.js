...
(function () {
  ...
  function renderBoard() {
    ...
    TASKS.forEach(function (task) {
      ...
      // A little instant-photo (Polaroid) fills the lower half of the cell.
      // Empty = plain black film; once the activity is done it holds the photo.
      var polaroid = document.createElement("span");
      polaroid.className = "cell-polaroid";
      polaroid.setAttribute("aria-hidden", "true");
      // Random, unique tilt on every load so no two photos sit the same way.
      polaroid.style.transform = "rotate(" + (Math.random() * 8 - 4).toFixed(2) + "deg)";
      var film = document.createElement("span");
      film.className = "cell-film";
      var thumb = document.createElement("img");
      thumb.className = "cell-thumb";
      thumb.alt = "";
      film.appendChild(thumb);
      polaroid.appendChild(film);
