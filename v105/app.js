...
(function () {
  ...
  // (html2canvas), used as-is. Falls back to the canvas redraw only if the
  ...
  function shareWholeCard() {
    ...
    ensureHtml2Canvas().then(function (h2c) {
      ...
      return h2c(target, {
        backgroundColor: "#d7e2ec", scale: scale, useCORS: true, logging: false,
