...
(function () {
  ...
  function buildMiniCard(p) {
    ...
    // Per-card progress — same look as the card-view progress bar, scaled down.
    ...
    var phead = document.createElement("div"); phead.className = "wm-progress-head";
    var pcount = document.createElement("span"); pcount.className = "wm-progress-count";
    pcount.textContent = doneN + "/" + TASKS.length;
    var ppct = document.createElement("span"); ppct.className = "wm-progress-pct";
    ppct.textContent = pct + "%";
    phead.appendChild(pcount); phead.appendChild(ppct);
