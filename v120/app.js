...
(function () {
  ...
  function buildMiniCard(p) {
    ...
    // Per-card progress — exactly the card view's progress component (same
    // markup, classes, text and count), scaled to the mini card via .wm-progress.
    var doneCount = Object.keys(p.done || {}).length;
    var total = TASKS.length;
    var pct = Math.round((doneCount / total) * 100);
    var prog = document.createElement("div"); prog.className = "wm-progress";
    var phead = document.createElement("div"); phead.className = "progress-head";
    var ptext = document.createElement("strong");
    ptext.textContent = doneCount + " of " + total + " complete";
    var ppct = document.createElement("span"); ppct.className = "progress-pct";
    ppct.textContent = pct + "%";
    phead.appendChild(ptext); phead.appendChild(ppct);
    ...
    prog.appendChild(phead); prog.appendChild(track);
    ...
    paper.appendChild(name); paper.appendChild(prog); paper.appendChild(board);
