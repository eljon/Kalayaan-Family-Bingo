...
(function () {
  ...
  function buildMiniCard(p) {
    ...
    TASKS.forEach(function (t) {
      var cell = document.createElement("span"); cell.className = "wm-cell";
      cell.style.background = ACCENTS[t.accent] || "#1f3a5f";
      var d = !!(p.done && p.done[t.id]); if (d) doneCount++;
      cell.style.opacity = d ? "1" : "0.16";
    ...
    card.appendChild(top); card.appendChild(grid); card.appendChild(meta);
